...
<html lang="en">
<head>
<title>Iron House Gym System Staff A/C</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Iron House Gym Staff A/C</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Iron House Gym's Equipment List <i class="icon icon-cogs"></i></h1>
  </div>
