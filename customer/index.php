...
<head>
        <title>Iron House Gym Management</title><meta charset="UTF-8" />
    ...
    <div id="loginbox">            
            ...
            <form id="recoverform" action="../customer/pages/register-cust.php" method="POST" class="form-vertical">
                ...
                <br>
                       ...
                       <div class="controls">
                            <div class="main_input_box">
                                <span class="add-on bg_lo"><i class="icon-leaf"></i></span><input type="number" name="contact" placeholder="Phone Number" />
                            </div>
                        </div>
