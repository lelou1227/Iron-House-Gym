...
<html lang="en">
<head>
<title>Iron House Gym Management</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Iron House Gym Admin</a></h1>
</div>
<!--close-Header-part--> 
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br> San Isidro Virac, <br>Catanduanes </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
